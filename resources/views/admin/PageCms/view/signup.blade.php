              ...
              <div class="accordion-item">
                <div class="accordion-header position-relative" id="headingWeDo">
                  <button class="accordion-button py-2 px-2 py-lg-2 px-lg-4" type="button"
                    ...
                    <span class="cta-2 fw-bold">Signup</span>
                  </button>
                         ...
                         {{--    <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="signup_label" class="form-control" placeholder="" value="{{ $page_section->Section->Signup->LabelName }}">
                                @error('signup_label')
                                  <span class="text-danger" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                    ...
                    <div class="page-content-section mb-4">
                      ...
                      <div class="card no-shadow border">
                        <div class="card-body py-2 px-2 py-lg-2 px-lg-4">
                          <div class="row">
                            <div class="col-12 col-sm-6">
                              <input type="hidden" name="signup_image" value="{{ $page_section->Section->Signup->Content->Image }}" id="signup_image">
                              <div class="mb-3">
...
@section('script')
  ...
  <script>
    $(document).ready(function(){
      ...
      if (document.getElementById('signup_image_dropzone')) {
        new Dropzone('#signup_image_dropzone', {
          ...
          init: function () {
            this.on('success', function (file, response) {
              $('#signup_image').val(response.file_path)
            });
            ...
            this.displayExistingFile(mockFile1, '{{ asset($page_section->Section->Signup->Content->Image) }}');
