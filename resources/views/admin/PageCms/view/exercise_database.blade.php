                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="mb-3">
                      ...
                      <input type="text" name="menu_text" class="form-control" placeholder="" value="Exercise Database">
                      @error('menu_text')
                          <span class="text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
              ...
              <div class="accordion-item">
                <div class="accordion-header position-relative" id="headingWeDo">
                  <button class="accordion-button py-2 px-2 py-lg-2 px-lg-4" type="button"
                    ...
                    <span class="cta-2 fw-bold">Exercise Database</span>
                  </button>
                         ...
                         {{--    <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="exerciseDatabase_label" placeholder="" value="{{ $page_section->Section->ExerciseDatabase->LabelName }}">
                                @error('exerciseDatabase_label')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                      ...
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                          <div class="alert alert-info" role="alert">
                            <b>Note :</b> The Exercises will be pulled from the exercise database.
                          </div>
                        </div>
                      </div>
                    </div>
