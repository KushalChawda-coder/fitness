              ...
              <div class="accordion-item">
                <div class="accordion-header position-relative" id="headingWeDo">
                  <button class="accordion-button py-2 px-2 py-lg-2 px-lg-4" type="button"
                    ...
                    <span class="cta-2 fw-bold">Footer</span>
                  </button>
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="footer_label" class="form-control" placeholder="" value="{{ $page_section->Section->Footer->LabelName }}">
                                @error('footer_label')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                      ...
                      <div class="card no-shadow border">
                        <div class="card-body py-2 px-2 py-lg-2 px-lg-4">
                          <div class="row">
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="footer_facebookLink" class="form-control" placeholder="" value="{{ $page_section->Section->Footer->Content->Facebook }}">
                                @error('footer_facebookLink')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                <label class="form-label">Twitters Link</label>
                                <input type="text" name="footer_twittersLink" class="form-control" placeholder="" value="{{ $page_section->Section->Footer->Content->Twitters }}">
                                @error('footer_twittersLink')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="footer_instagramLink" class="form-control" placeholder="" value="{{ $page_section->Section->Footer->Content->Instagram }}">
                                @error('footer_instagramLink')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
