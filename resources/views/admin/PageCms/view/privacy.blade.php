              ...
              <div class="accordion-item">
                <div class="accordion-header position-relative" id="headingWeDo">
                  <button class="accordion-button py-2 px-2 py-lg-2 px-lg-4" type="button"
                    ...
                    <span class="cta-2 fw-bold">Privacy</span>
                  </button>
                         ...
                         {{--    <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="privacy_label" placeholder="" value="{{ $page_section->Section->Privacy->LabelName }}">
                                @error('privacy_label')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="page-content-section mb-4">
                      ...
                      <div class="card no-shadow border">
                        <div class="card-body py-2 px-2 py-lg-2 px-lg-4">
                          <div class="row">
                            <div class="col-12 col-sm-6">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="privacy_sub_title" placeholder="" value="{{ $page_section->Section->Privacy->Content->Title }}">
                                @error('privacy_sub_title')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                          ...
                          <input type="hidden" name="privacy_description" id="privacy_description" value="">
                          <div class="row">
                            <div class="col-12 col-sm-12 col-lg-12">
                              <div class="mb-3">
                                <label class="form-label">Description</label>
                                <div class="html-editor-bubble sh-19 html-editor" id="privacy_description_editor">
                                {{ strip_tags($page_section->Section->Privacy->Content->Description) }}
                                </div>
                              </div>
                            </div>
                          </div>
  ...
  <!-- Page Specific Scripts End -->
   <script>
    $(document).ready(function(){
      ...
      var quill = new Quill('#privacy_description_editor', {
        modules: {
      ...
      quill.on('text-change', function() {
        ...
        $('#privacy_description').val(strippedContent);
      });
