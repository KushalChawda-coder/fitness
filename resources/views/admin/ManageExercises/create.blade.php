...
<div class="container">
  ...
  <form action="{{ route('manageExercises.store') }}" id="manage-exercises" method="post">
  @csrf
  <div class="page-title-container">
    <div class="row">
      ...
      <div class="col-sm-12 col-md-5 col-lg-7 col-xxl-9 d-flex justify-content-end align-items-start mt-1">
        <div class="d-flex">
          ...
          <div class="form-check form-switch ms-2 mb-0">
            <input class="form-check-input checkbox-status" name="status" id="updateStatus" type="checkbox" role="switch" value="1" checked>
          </div>
      ...
      <div class="col-sm-12 col-md-2 col-lg-2 col-xxl-1 text-end mb-1">
        ...
        <a href="https://000stagehtmlcss.s3.amazonaws.com/FitnessandMealPlans/105-v4/src/index.html" role="button"
        ...
        <div class="tab-pane fade active show" id="first" role="tabpanel">
                  ...
                  <div class="col-12 col-sm-12">
                    <div class="mb-3">
                      ...
                      <input id="tagsBodyPart" class="custom-look" name="body_part_ids" placeholder="Search for body part"
                        value="{{ old('body_part_ids') }}" data-blacklist="null@null.com" required>
                ...
                <div class="row">
                  <div class="col-12 col-xl-12">
                    <div class="mb-3">
                      ...
                      <input id="tagsEquipment" class="custom-look" name="equipments_ids" placeholder="Search for body part" value="{{ old('equipments_ids') }}" data-blacklist="null@null.com" required>
                      <button class="btn btn-icon btn-icon-only btn-outline-primary mb-1" type="button">
                        <i data-acorn-icon="plus"></i>
                      </button>
                ...
                <div class="row">
                  <div class="col-12 col-xl-12">
                    <div class="mb-3">
                      ...
                      <input id="tagsExerciseType" class="custom-look" name="exercise_type_ids" placeholder="Search for body part" value="{{ old('exercise_type_ids') }}" data-blacklist="null@null.com" required>
                      <button class="btn btn-icon btn-icon-only btn-outline-primary mb-1" type="button">
                        <i data-acorn-icon="plus"></i>
                      </button>
                ...
                <div class="row">
                  <div class="col-12 col-xl-12">
                    <div class="mb-3" id="highlightMediaContainer">
                      ...
                      @foreach(old('highlight_images') as $i => $media)
                        <input type="hidden" name="highlight_images[]" value="{{ $media }}">
                      @endforeach
                      @endif
          ...
          <div class="pagesection mb-4">
            <div class="mb-1">
              ...
              <div class="html-editor-bubble sh-19 html-editor" id="BenefitsEditor">{{ old('benefits') }}</div>
            </div>
            <input type="text" id="benefits" class="invisible p-0" name="benefits"  value="{{ old('benefits') }}" required>
            @error('benefits')
              <span class="text-danger d-block" role="alert">
                  <strong>{{ $message }}</strong>
              </span>
            ...
            <div class="card no-shadow border mb-4">
              ...
              <div id="directions-container">
                <div class="row mb-2 direction-row" index="1">
                  <div class="col-auto">
                  ...
                  <div class="col">
                    <div class="card-body d-flex flex-column ps-0 pe-0 pt-0 pb-0 h-100 justify-content-start">
                      <div class="d-flex flex-column">
                        <div class="mt-1 mb-1">
                          <div class="html-editor-bubble sh-19 html-editor direction-description-editor" id="direction-description-1">{{ old('directions')[0] ?? null }}</div>
                        </div>
                        <input type="text" class="direction_description invisible p-0" name="directions[1]"  value="{{ old('directions')[0] ?? null }}" required>
                        @error('directions.1')
                  ...
                  <div class="col-auto d-flex flex-column" id="direction-btn-container">
                    ...
                    <button type="button" id="create-direction" class="btn btn-sm btn-icon btn-icon-only btn-outline-danger mb-1 direction-delete-btn" disabled>
                      <i data-acorn-icon="bin"></i>
                    </button>
                  </div>
                </div>
                @if(!empty(old('directions')))
                @foreach(old('directions') as $i => $direaction)
                @if(!$loop->first)
                <div class="row mb-2 direction-row" index="{{ $i }}">
                  ...
                  <div class="col">
                    <div class="card-body d-flex flex-column ps-0 pe-0 pt-0 pb-0 h-100 justify-content-start">
                      <div class="d-flex flex-column">
                        <div class="mt-1 mb-1">
                          <div class="html-editor-bubble sh-19 html-editor direction-description-editor" id="direction-description-{{ $i+1 }}">{{ $direaction ?? null }}</div>
                        </div>
                        <input type="text" class="direction_description invisible p-0" name="directions[{{ $i }}]"  value="{{ $direaction ?? null }}" required>
                        @error('directions.'.$i+1)
                          <span class="text-danger d-block direction-description-err" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                        @enderror
            ...
            <div class="card no-shadow border mb-4">
              <div class="card-body py-2 px-2 py-lg-3 px-lg-3">
                <div class="mb-1" id="DirectionVideosContainer">
                  ...
                  @foreach(old('direction_videos') as $i => $video)
                ...
                <div class="row">
                  <div class="col-12 col-sm-12">
                    <div class="mb-3 mt-2">
                      ...
                      <input type="url" class="form-control" id="video_link" name="video_link" placeholder="" value="{{ old('video_link') }}" required>
                      @error('video_link')
                        <span class="text-danger d-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
           ...
           <div class="row">
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                ...
                <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="form-control meta-input" placeholder="">
                @error('meta_title')
                  <span class="text-danger" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="meta_friendly_url" value="{{ old('meta_friendly_url') }}" class="form-control meta-input" placeholder="">
              ...
              <div class="mb-3">
                <div class="card no-shadow bg-light">
                  <div class="card-body py-2 px-2 py-lg-2 px-lg-4">
                    ...
                    <p id="pageDesc">This is a place where user can go and get their website to host their fitness and mealplans.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        init: function () {
          this.on('success', function (file, response) {
            ...
            if (file.type.startsWith('video/')) {
              ...
              file.previewElement.querySelector('.preview-container').appendChild(videoPlayer);
              videoPlayer.play();
            }
          });
