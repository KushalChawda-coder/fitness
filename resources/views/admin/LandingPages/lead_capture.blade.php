	                    ...
	                    <div class="row">
	                      ...
	                      <div class="col-12 col-sm-6">
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="menu_text" value="{{ old('menu_text') }}" placeholder="menu text" required>
		                        @error('menu_text')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                    ...
	                    <div class="row">
	                      <div class="col-12 col-xl-6">
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="brand_name" placeholder="Your Brand" value="{{ old('brand_name') }}" required>
	                         	@error('brand_name')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                        ...
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="service_name" value="{{ old('service_name') }}" placeholder="Your Services" required>
	                          	@error('service_name')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                        ...
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="app_name" value="{{ old('app_name') }}" placeholder="Your App" required>
	                          	@error('app_name')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                        ...
	                        <div class="mb-3">
	                          ...
	                          <div class="mb-3 border no-shadow position-relative" id="singleImageUpload">
	                            <img src="{{ asset('assets/admin/plan-img/hero_iphone_14.jpg') }}" class="card-img-top rounded-3 sh-52"
	                              alt="image">
	                            <div class="position-absolute me-2 mt-2 b-2 e-2 d-inline-block"
	                              ...
	                              <input class="file-upload t-0 e-2 s-0" type="file" name="banner_image" accept="image/*" required>
	                            </div>
	                          </div>
	                        </div>
    	                      	@error('banner_image')
	                      ...
	                      <div class="col-12 col-xl-6">
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="bar_text" value="{{ old('bar_text') }}" placeholder="bar text" required>
	                          	@error('bar_text')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                        ...
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="sub_text" value="{{ old('sub_text') }}" required>
	                          	@error('sub_text')
				                  <span class="text-danger" role="alert">
				                      <strong>{{ $message }}</strong>
				                  </span>
	                        ...
	                        <div class="mb-3">
	                          ...
	                          <input type="text" class="form-control" name="lead_collection" value="{{ old('lead_collection') }}" required>
	                    ...
	                    <div class="mb-3">
	                      <div class="card no-shadow bg-light">
	                        <div class="card-body py-2 px-2 py-lg-2 px-lg-4">
	                        	...
	                        	<input type="hidden" name="landing_page_type" value="{{ \App\Models\admin\LandingPage::LEAD_CAPTURE }}">
