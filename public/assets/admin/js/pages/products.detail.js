...
class ProductsDetail {
  ...
  _initDropzone() {
    ...
    //       let mockFile1 = { name: 'cupcake.jpg', size: 249430 };
    //       this.displayExistingFile(mockFile1, 'img/product/small/product-3.jpg');
    ...
    if (document.getElementById('dropzoneResourceImage')) {
      new Dropzone('#dropzoneResourceImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
    ...
    if (document.getElementById('dropzoneLivePreviewImage')) {
      new Dropzone('#dropzoneLivePreviewImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
        init: function () {
          ...
          // If you only have access to the original image sizes on your server,
          // and want to resize them in the browser:
          let mockFile1 = { name: 'Coach-Home.jpg', size: 249430 };
          this.displayExistingFile(mockFile1, 'plan-img/Coach-Home.png');
    ...
    if (document.getElementById('dropzoneNewFeatureImage')) {
      new Dropzone('#dropzoneNewFeatureImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
        init: function () {
          ...
          // If you only have access to the original image sizes on your server,
          // and want to resize them in the browser:
          let mockFile1 = { name: 'Feature.jpg', size: 249430 };
          this.displayExistingFile(mockFile1, 'img/product/small/payment-integration.jpg');
    ...
    if (document.getElementById('dropzoneFitness2Image')) {
      new Dropzone('#dropzoneFitness2Image', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
        init: function () {
          ...
          // If you only have access to the original image sizes on your server,
          // and want to resize them in the browser:
          let mockFile1 = { name: 'Airbike.jpg', size: 249430 };
          this.displayExistingFile(mockFile1, 'img/product/small/product-3.jpg');
    ...
    if (document.getElementById('dropzoneFitnessImage')) {
      new Dropzone('#dropzoneFitnessImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
    ...
    if (document.getElementById('dropzoneSliderImage')) {
      new Dropzone('#dropzoneSliderImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
    ...
    if (document.getElementById('dropzoneBannerImage')) {
      new Dropzone('#dropzoneBannerImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
        init: function () {
          ...
          // If you only have access to the original image sizes on your server,
          // and want to resize them in the browser:
          let mockFile1 = { name: 'banner.jpg', size: 249430 };
          this.displayExistingFile(mockFile1, 'plan-img/coach-portal-105.jpg');
    ...
    if (document.getElementById('dropzoneArticleImage')) {
      new Dropzone('#dropzoneArticleImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
    ...
    if (document.getElementById('dropzoneFeatureImage')) {
      new Dropzone('#dropzoneFeatureImage', {
        url: 'https://httpbin.org/post',
        thumbnailWidth: 600,
        thumbnailHeight: 430,
        previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
      ...
      if (document.getElementById('dropzoneFeatureImageButton')) {
        document.getElementById('dropzoneFeatureImageButton').addEventListener('click', (event) => {
          document.getElementById('dropzoneFeatureImage').dispatchEvent(new Event('click'));
        });
      }
    }
    ...
    // if (document.getElementById('dropzoneProductVideo')) {
    //   new Dropzone('#dropzoneProductVideo', {
    //     url: 'https://httpbin.org/post',
    //     thumbnailWidth: 600,
    //     thumbnailHeight: 430,
    //     previewTemplate: DropzoneTemplates.columnPreviewImageTemplate,
    ...
    //       // If you only have access to the original image sizes on your server,
    //       // and want to resize them in the browser:
    //       let mockFile1 = { name: '07081201-Side-Crunch_Waist.mp4', size: 203100 };
    //       this.displayExistingFile(mockFile1, 'img/product/small/product-10.webp');
    ...
    //       document.getElementById('dropzoneProductVideo').dispatchEvent(new Event('click'));
    //     });
    //   }
    // }
