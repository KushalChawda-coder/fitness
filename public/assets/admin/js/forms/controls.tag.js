...
class TagControls {
  ...
  // Custom body part tags
  // _initTagsCustomLook() {
  //   if (document.querySelector('#tagsBodyPart')) {
  ...
  //     var input = document.querySelector('#tagsBodyPart');
  ...
  //   }
  //   if (document.querySelector('#tagsEquipment')) {
  //     // generate random whilist items (for the demo)
  ...
  //     var input = document.querySelector('#tagsEquipment');
  //     var tagifyBodyPart = new Tagify(input, {
  //       // pattern: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
  //       whitelist: randomStringsArr,
  //       callbacks: {
  ...
  //     function onInvalidTag(e) {}
  //   }
  //   if (document.querySelector('#tagsExerciseType')) {
  //     // generate random whilist items (for the demo)
  ...
  //     var input = document.querySelector('#tagsExerciseType');
  //     var tagifyBodyPart = new Tagify(input, {
  //       // pattern: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
  //       whitelist: randomStringsArr,
  //       callbacks: {
